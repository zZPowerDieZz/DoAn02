...
namespace DoAn.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult Index(int ? page, string textsearch = "")
        {
            ...
            productList = _db.Products.Include(x => x.Category).Where(p => p.Name.ToLower().Contains(textsearch.ToLower())).ToList();
        ...
        {
            var product = _db.Products.Where(x => x.Id == productId).ToList();
